				...
				<div className="flex flex-col md:flex-row items-start w-full gap-6">
					...
					<div className="w-full md:w-3/4 pl-4">
						...
						<p>
							...
							</p><br/><p>We experienced a
							major breakthrough in 2021 when we learned from our out-of-state
							partners that the Clay County jail made a contract with a private
							company called Securus Technologies, which allowed detained
							immigrants to video conference with friends and family at
							exorbitant rates. Although we had reservations about providing
							financial support to this exploitative company, we took advantage
							of the pathway it created for us to reach detained immigrants. We
							raised the funds to pay for video calls on our end and started
							reaching out to the immigrants in the jail and offering to listen
							to their stories and offer support where possible. This generated
							significant interest, and we began establishing relationships in
							both of the cell blocks at the jail that held immigrants. 
							</p><br/><p>
						In 2022,
							the jail finally acknowledged the end of the COVID-19 emergency
							and allowed us to come in through the Community Stakeholder
							request. We met the local sheriff, jail commander, ICE
							...
							it’s important to acknowledge the shifts that have occurred since
							2024. In 2024, the Clay County Council signed an agreement with
							the US government to expand their ICE detention wing, which went
							from having two cells and a maximum of about 60 people to having
							10 cells and a maximum of about 300 people (which it periodically
							exceeds). This was partially a response to the decision made by
							the state of Illinois to end ICE detention and the government’s
							perceived need to create more detention locations in the midwest.
							We celebrate this decision by the state of Illinois, but one of
							the unfortunate effects was that it led to one of our largest and
							closest partner organizations - the Interfaith Coalition for
							Detained Immigrants, based in Chicago - to end its visitation
							program. This means that we are now the only active visitation
							group in the Chicago immigration “circuit” and we have a much
							bigger responsibility than we did even a few years ago. In other
