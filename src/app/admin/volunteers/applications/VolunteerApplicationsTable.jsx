					...
					<table className="table-fixed w-full bg-white border border-gray-200">
						<thead>
							<tr>
								...
								<th className="px-6 py-3 border-b border-gray-200 text-center text-sm font-semibold text-gray-700 sticky top-0 bg-gray-100">Actions</th>
							</tr>
						</thead>
						<tbody>
							{filteredApps.map((app) => (
								<tr key={app.id}>
									...
									<td className="px-6 py-4 border-b border-gray-200 text-blue bg-gray-100 text-center hover:underline cursor-pointer" onClick={() => onView(app)}>View</td>
								</tr>
							))}
						</tbody>
					</table>
