...
export default function NewsletterCard({ newsletters, subscriberCount }) {
	...
	return (
		<div className="bg-white shadow-md rounded-lg p-6">
			...
			<p className="mb-4">
				Total Newsletters:{' '}
				<span className="font-bold">{newsletters.total_issues / 2}</span>
			</p>
			<p className="mb-4">
				Current Issue:{' '}
				<span className="font-bold">{newsletters.current_issue}</span>
			</p>
			<p className="mb-4">
				Current Issue Date:{' '}
				<span className="font-bold">
					{new Date(newsletters.current_issue_date).toLocaleDateString()}
				</span>
			</p>
			<p className="mb-4">
