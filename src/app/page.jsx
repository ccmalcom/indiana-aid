			...
			<div className="flex align-center justify-center ">
				<div
					...
					<div className="card-buttons flex flex-col items-center justify-center mb-4">
						<button className="bg-yellow hover:bg-yellow-dark text-black font-bold py-2 px-4 my-4  rounded ">
							Read Latest Release
						</button>
						<Link href="/resources/newsletter" className="hover:text-yellow">
							Subscribe
						</Link>
					</div>
				</div>
				<div
					...
					<div className="card-buttons flex flex-col items-center justify-center">
						<button className="bg-yellow hover:bg-yellow-dark text-black font-bold py-2 px-4 my-4 mx-2  rounded ">
							Join Mailing List
						</button>
				...
				<div
					...
					<div className="flex flex-col items-center justify-center">
						<a
							...
							target="_blank"
							rel="noopener noreferrer">
							<button className="bg-red hover:bg-red-dark text-white font-bold py-2 px-4 mt-4 mx-2 rounded ">
								Find Help
							</button>
						</a>
						<button className="bg-yellow hover:bg-yellow-dark text-black font-bold py-2 px-4 mt-4 mx-2  rounded ">
							Know Your Rights
						</button>
					</div>
				</div>
